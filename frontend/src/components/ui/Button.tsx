...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const baseStyles =
      'inline-flex items-center justify-center rounded-sm border border-transparent font-semibold shadow-sm focus:outline-none focus:ring-0.5 focus:ring-offset-0.5 focus:ring-offset-gray-900 transition-colors duration-150 ease-in-out disabled:opacity-50 disabled:cursor-not-allowed';
    ...
    const variantStyles = {
      ...
      outline:   `bg-transparent border-gray-600 text-gray-300 hover:bg-gray-700/50 focus:ring-gray-500`,
      ghost:     `bg-transparent border-transparent text-gray-300 hover:text-white hover:bg-gray-700/50 focus:ring-gray-200`,
    };
